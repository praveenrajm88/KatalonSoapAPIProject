...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>b83cfe9f-9fac-4138-8be2-8517d3dfe0e3</elementGuidId>
...
WS.verifyElementText(response, 'ListOfCurrenciesByNameResponse.ListOfCurrenciesByNameResult.tCurrency[0].sISOCode', 'AFA')</verificationScript>
